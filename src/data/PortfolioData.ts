...
const PORTFOLIO_DATA: PortfolioData = {
  ...
  experience: [
    { year: "2025", role: "Software Engineer Intern", company: "GlobalTek BPO INC.", desc: "GlobalTek consists of the Philippine Software Engineering team for Trajector US. Started a paid internship as a software engineer intern focusing on full stack web development with React, Next, and AWS."},
