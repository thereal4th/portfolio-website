...
const PORTFOLIO_DATA: PortfolioData = {
  ...
  experience: [
    { year: "2025", role: "Software Engineer Intern", company: "GlobalTek BPO INC.", desc: "GlobalTek serves as the Philippine Software Development team for Trajector Medical, a US-based company. Working as a paid software engineer intern focusing on full stack web development with React, Next, and AWS."},
